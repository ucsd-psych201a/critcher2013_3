...
- For the moral condition, on different occasions, Justin and Nate are at the grocery store’s parking lot. Both individuals come across a cash-filled wallet. Justin quickly decides to return the wallet to customer service instead of stealing the money. Nate makes the same decision, but he reaches his conclusion after spending a long time thinking about it.
