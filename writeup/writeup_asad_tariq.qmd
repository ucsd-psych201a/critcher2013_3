...
**(note: since we haven't done data collection yet, our planned and actual sample are the same)**
...
dat <- read.csv("../data/cleaned_data_pilotB.csv")
...
After having perfomed our planned analysis we intend to do a comparative analysis with the data obtained from an associated graduate student group who is replicating the same experiment. The data they collect will undergo the same statistical tests as in our replication and the obtained results will be compared with our own replication through descriptive statistics and independent sample t-tests terms of how decision speed influences moral evaluations in both data.
