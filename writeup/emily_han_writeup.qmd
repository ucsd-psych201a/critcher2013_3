...
First, paired t-test was conducted to examine whether manipulation of decision speed was successful. As expected, Justin was rated as a faster decision maker in comparison to Nate, *F*(1, 206) = 15.915, *p* \< 2.2e-16, across both moral and immoral condition (whether they decided to keep or return the wallet).

As confirmatory analysis, 2x2 repeated measures ANOVA was conducted to examine the effects of **Moral Condition** (moral vs immoral) and **Decision Speed** (fast vs slow) on **moral character evaluation**.

The main effect of **moral condition** was **consistent** for both combined data and the subset of Group 3's subset data. The combined data shows that there is **significant main effec**t of condition was found, F(1,408) = 312.66, *p* \<.001, highlighting a strong influence of moral condition on moral character evaluation. The subset data also shows that a **significant main effect** of condition F(1,184) = 113.88, *p*\<.001. This results suggests that the agents' decision itself, whether to steal the money (immoral) or to return the money (moral), has significant influence on how the agents' moral characters are perceived regardless of how fast or how slow they arrived to that decision.

The main effect of **decision speed** was **not consistent;** it was **not** **significant** for combined data, but it was **significant** for the subset of Group 3's data. The combined data shows that there is **no significant main effect** of condition was found, F(1,408) = 0.053, *p* = .819. This is suggesting that regardless of the agents' decision, moral or immoral, how fast or slow the agents' arrive to that decision has no significant influence on how the agents' moral character is precieved. However, the subset data suggests otherwise meaning how fast or slow the decision was made has **significant effect** on how the agents' moral character is perceived, F(1,184) = 5.01, *p* = .026.

The interaction effect of **moral condition** was **consistent** for both combined data and the subset of Group 3's subset data. It was **significant** for both combined data \[F(1, 408) = 191.21, *p* \< .001\] and the subset of Group 3's data \[F(1,184) = 92.63, *p* \< .001\]. This confirms that decision speed (Quick vs. Slow) influences perception on the agents' moral character differently depending on whether they made moral decision or immoral decision. In comparison to Nate, who made a slow decision, Justin who made quick decision will be perceived as a more moral person when he return the money and perceived as a more immoral person when he steal the money. For Nate, who made a slow decision, perception on his moral character were more **neutral** or less extreme, regardless of whether he made a moral or immoral decision. This suggests that decision speed amplifies perceptions of moral character for Justin, while Nate's slower decision making leads to less polarized perception.

## Discussion

### Summary of Replication Attempt

In general, the results largely replicate the findings of the original study, particularly the strong interaction effect between moral condition and decision speed. The main effect of moral condition was consistent across both datasets, emphasizing the robust influence of decision type on moral character evaluations. However, the main effect of decision speed showed partial replication, with differences observed between the combined dataset and subset. The current study's larger sample size may have reduced variability, particularly in the combined dataset, making it harder to detect the main effect of decision speed. Overall, the most of the results supports the conclusion that decision speed amplifies moral evaluations depending on the nature of the decision.

### Commentary

This replication supports the interaction effect between moral condition and decision speed as a robust finding. Differences in the main effect of decision speed suggest the presence of potential moderators such as perceived certainty and variability in sample characteristics could help clarify the contextual and psychological mechanisms underlying these effects.
